...
mcmc.NN <- bayou.makeMCMC(pruned, dat, pred=logBody, model=model.NN$model, prior=prior.NN, startpar=model.NN$startpar, 
                         file.dir="result_mcmc", outname="modelNN_r001", plot.freq=NULL, ticker.freq = 2000, samp = 200, SE = ME)
...
ss.NN <- mcmc.NN$steppingstone(10000000, c_chainNN, Bk, burnin=0.25, plot=FALSE)
